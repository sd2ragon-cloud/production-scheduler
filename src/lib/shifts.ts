...
//  정시(야): 15:30 ~ 당일 22:30
//  단부정시: 08:30 ~ 당일 17:30
//  정시(20시): 08:30 ~ 당일 20:00
//  정시(21시): 08:30 ~ 당일 21:00
//  정시(22시): 08:30 ~ 당일 22:00
//  정시(23시): 08:30 ~ 당일 23:00
//  정시(24시): 08:30 ~ 당일 24:00
...
export const SHIFTS: Record<string, ShiftDef> = {
  ...
  "정시(20시)": { start: 8 * 60 + 30, end: 20 * 60 },
  "정시(21시)": { start: 8 * 60 + 30, end: 21 * 60 },
  "정시(22시)": { start: 8 * 60 + 30, end: 22 * 60 },
  "정시(23시)": { start: 8 * 60 + 30, end: 23 * 60 },
  "정시(24시)": { start: 8 * 60 + 30, end: 24 * 60 },
};

// 칩 표시 순서
export const SHIFT_NAMES: string[] = ["정상(주)", "정상(야)", "정시(주)", "정시(야)", "단부정시", "정시(20시)", "정시(21시)", "정시(22시)", "정시(23시)", "정시(24시)"];
