...
export default function OrdersPage() {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-4 py-2 rounded-full bg-black/[0.06] text-gray-700 text-sm font-medium hover:bg-black/[0.1] transition"
          >
            전체 대기 상태로
          </button>
          <button
            onClick={() => { setShowForm(true); setEditingId(null); setForm(emptyOrder); }}
            className="px-4 py-2 rounded-full bg-[#0071e3] text-white text-sm font-medium hover:bg-[#0077ed] transition shadow-sm"
          >
            + 주문 추가
          </button>
        </div>
      ...
      {isAdmin && showForm && (
        <div className="bg-white shadow-sm border border-black/5 rounded-2xl p-6 mb-6">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2 flex gap-2 justify-end">
              <button
                ...
                className="px-4 py-2 rounded-full bg-black/[0.06] text-gray-700 text-sm hover:bg-black/[0.1]"
              >
                취소
              </button>
              <button
                type="submit"
                className="px-4 py-2 rounded-full bg-[#0071e3] text-white text-sm font-medium hover:bg-[#0077ed]"
              >
                {editingId ? "수정" : "등록"}
              </button>
            </div>
