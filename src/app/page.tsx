                ...
                <table className="w-full">
                  <thead>
                    <tr className="text-gray-500 text-[10px] border-b h-7">
                      ...
                      <th className="px-1.5 py-0 text-center w-28 min-w-[5rem] whitespace-nowrap">비고</th>
                      <th className="px-1.5 py-0 text-center w-28 min-w-[5rem] whitespace-nowrap">소요(시간)</th>
                      <th className="px-1.5 py-0 text-left w-20 min-w-[3.5rem] whitespace-nowrap">예상완료</th>
                      <th className="px-1.5 py-0 text-left w-20 min-w-[3.5rem] whitespace-nowrap">납기</th>
                    ...
                    {entries.map((entry) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-1.5 py-0 w-full align-middle">
